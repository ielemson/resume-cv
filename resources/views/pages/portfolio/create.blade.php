                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('portfolio.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select  name="cat_id" class="form-control {{ $errors->has('cat_id') ? "is-invalid":"" }}" value="{{ old('cat_id') }}" required>
                            ...
                            <div class="form-group">
                                <label>Link</label>
                                <input type="link" name="link" class="form-control {{ $errors->has('link') ? "is-invalid":"" }}" value="{{ old('link') }}" required>
                            ...
                            <div class="form-group">
                                <label>Name</label>
                                <textarea  name="description" id="summernote" class="form-control {{ $errors->has('description') ? "is-invalid":"" }}"  required>{{ old('description') }}</textarea>
